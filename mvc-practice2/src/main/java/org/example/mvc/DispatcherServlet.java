...
public class DispatcherServlet extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestMathod requestMathod = RequestMathod.valueOf(request.getMethod());
        ...
        try {
            ...
            // 리스트로 받으므로 아랫줄은 없어짐
            // findHandler(new HandlerKey(RequestMathod.valueOf(request.getMethod()), request.getRequestURI()));


            // redirect와 forward 처리를 각각 해줘야함
            ...
            for (ViewResolver viewResolver : viewResolvers) {
                View view = viewResolver.resolveViews(modelAndView.getViewName());
